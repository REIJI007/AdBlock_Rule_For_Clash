...
<table border="1" style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif;">
  ...
  <tr>
    ...
    <td style="padding: 8px;">
      ...
      <strong><a href="https://cdn.statically.io/gh/REIJI007/AdBlock_Rule_For_Clash/main/adblock_reject.yaml" style="color: #0066cc;">Statically 加速链接</a></strong>
    </td>
  </tr>
  <tr>
    ...
    <td style="padding: 8px;">
      ...
      <strong><a href="https://cdn.statically.io/gh/REIJI007/AdBlock_Rule_For_Clash/main/adblock_reject.mrs" style="color: #0066cc;">Statically 加速链接</a></strong>
    </td>
  </tr>
  <tr>
    ...
    <td style="padding: 8px;">
      ...
      <strong><a href="https://cdn.statically.io/gh/REIJI007/AdBlock_Rule_For_Clash/main/adblock_reject.txt" style="color: #0066cc;">Statically 加速链接</a></strong>
    </td>
  </tr>
</table>
...
dns:
  enable: true
  nameserver-policy:
    'geosite:category-ads-all': rcode://success			            #DNS模块拦截
  
rule-providers:
  adblock:											#定义名为adblock的规则集
    type: http
    behavior: classical
...
**三、本仓库引用的广告过滤规则来源请查看[Referencing rule sources.txt](https://github.com/REIJI007/AdBlock_Rule_For_Clash/blob/main/Referencing%20rule%20sources.txt)（目前300个来源）。至于是否误杀域名完全取决于这些处于上游的广告过滤器的域名拦截行为，你可按在本地使用powershell脚本进行DIY本地定制化，亦或者fork本仓库自行DIY**


**四、特别鸣谢**

1. [mihomo](https://github.com/MetaCubeX/mihomo)
2. [AdAway](https://github.com/AdAway/AdAway)
3. [AdBlocker](https://adblockultimate.net/filters)
4. [Adguard](https://github.com/AdguardTeam/AdGuardFilters)
5. [Easylist](https://github.com/easylist/easylist)
6. [uBlockOrigin](https://github.com/uBlockOrigin/uAssets)
7. [URLhaus](https://urlhaus.abuse.ch/)
8. [malware-filter](https://gitlab.com/malware-filter)
